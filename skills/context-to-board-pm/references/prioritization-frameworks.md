...
driver attention** (`references/sizing.md`). ICE is the fast rough-cut when a full CoD estimate isn't worth
it.
...
- **CD3 is the WSJF arithmetic** (CoD ÷ Duration). Cadre uses it as the **ready-lane default for
  individual stories**, with **Duration = driver attention** (`references/sizing.md`) rather than effort. At
